...
<section class="mx-auto flex h-full w-full max-w-sm flex-col items-center justify-evenly">
	...
	<form class="flex w-full flex-col gap-6" method="post" action="?/signInEmail" use:enhance>
		<div class="flex flex-col gap-1">
			<h1 class="text-xl font-semibold">Sign In to Hubris</h1>
		...
		<div class="flex flex-col gap-4">
			...
			<Button class="w-full" formaction="?/signInEmail">Continue</Button>
		</div>
